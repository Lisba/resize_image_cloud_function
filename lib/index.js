...
app.post('/image', (req, res, next) => {
    ...
    form.parse(req, (err, _fields, files) => {
        ...
        fs.readFile(imageData === null || imageData === void 0 ? void 0 : imageData.filepath, function (err, data) {
            if (err) {
                throw err;
            }
            const storage = getStorage(firebase, 'gs://thumbnail-generator-ui.appspot.com/');
            const storageRef = ref(storage, `images/${imageData === null || imageData === void 0 ? void 0 : imageData.originalName}`);
            const metadata = {
